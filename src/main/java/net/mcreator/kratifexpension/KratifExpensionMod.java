package net.mcreator.kratifexpension;
...
@Mod("kratif_expension")
public class KratifExpensionMod {
	public static final Logger LOGGER = LogManager.getLogger(KratifExpensionMod.class);
	public static final String MODID = "kratif_expension";

	public KratifExpensionMod() {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		KratifExpensionModSounds.REGISTRY.register(bus);
		KratifExpensionModBlocks.REGISTRY.register(bus);

		KratifExpensionModItems.REGISTRY.register(bus);

		KratifExpensionModTabs.REGISTRY.register(bus);
